...
function Menu() {
    ...
    const [currentIndex, setCurrentTndex] = useState(0);
            ...
            <nav className="cocktail-tabs" aria-label="Cocktail-navigation">
                {allCocktails.map((cocktail, index) => {
                    ...
                    return (
                        ...
                        <button key={cocktail.id} className={`${isActive ? 'text-white border-white' : 'text-white/50 boredr-white/50'}`}
